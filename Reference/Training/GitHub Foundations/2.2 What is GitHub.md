...
2. Above the list of files, click the **Code** button.
    ...
    ![Screenshot of the Code button dropdown menu with clone options.](https://learn.microsoft.com/en-us/training/github/introduction-to-github/media/2-selecting-code-button.png)
