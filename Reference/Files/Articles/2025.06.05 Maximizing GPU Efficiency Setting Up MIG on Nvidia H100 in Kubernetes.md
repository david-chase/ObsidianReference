...
- Depending on how you subdivide your GPUs into MIGs you may end up leaving significant amounts of capacity unutilized
- For example, an H100 can be split into 4 x 1g.24gb GPUs.  Since you're only using 4 of 7 GPU compute slices, this means about 43% of your total GPU compute capacity is stranded.
- MIG plan is provided in the values.yaml used to deploy the NVIDIA GPU Operator
